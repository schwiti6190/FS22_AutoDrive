...
source(Utils.getFilename("scripts/Editor/Brushes/BaseBrush.lua", g_currentModDirectory))
source(Utils.getFilename("scripts/Editor/Brushes/Waypoints/ConnectWaypoints.lua", g_currentModDirectory))
source(Utils.getFilename("scripts/Editor/Brushes/Waypoints/CreateWaypoint.lua", g_currentModDirectory))
source(Utils.getFilename("scripts/Editor/Brushes/Waypoints/DeleteWaypoint.lua", g_currentModDirectory))
...
source(Utils.getFilename("scripts/Editor/Brushes/Destinations/DeleteDestination.lua", g_currentModDirectory))
source(Utils.getFilename("scripts/Editor/EditorGraphWrapper.lua",g_currentModDirectory))
source(Utils.getFilename("scripts/Editor/EditorGUI.lua",g_currentModDirectory))
